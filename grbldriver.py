...
class GrblDriver:
    ...
    def __init__(self, address='COM4'):
        ...
        self.xconfig = {
            ...
            'steps/mm':640.4 #<--sets resolution, chosen so that 0.001mm = 1 step, the minimum resolution of GRBL
            }
        ...
        self.yconfig = {
            'steps/sec':6400, #<--the actual important parameter
            'steps/sec2':5000, #<--acceleration
            'steps/mm':105.87 #<--sets resolution, chosen so that 0.001mm = 1 step, the minimum resolution of GRBL
            }
        ...
        self.zconfig = {
            'steps/sec':6400, #<--the actual important parameter
            'steps/sec2':5000, #<--acceleration
            'steps/mm':640 #<--sets resolution, chosen so that 0.001mm = 1 step, the minimum resolution of GRBL
            }
